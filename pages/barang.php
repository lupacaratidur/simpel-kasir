...
<head>
  ...
  <title>Data Barang - SiKasir</title>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
      <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
          ...
          <li class="nav-item" role="presentation"><a class="nav-link active" href="barang.php"><i class="icon-layers"
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 text-nowrap">
                  <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"></div><a
                    href="barang-tambah.php" class="btn btn-primary" type="button"
                    style="background-color: #1cc88a;">Tambah Barang</a>
                </div>
                <div class="col-md-6">
                  <form>
                    <div class="text-md-right dataTables_filter" id="dataTable_filter"><label><input type="search"
                          class="form-control form-control-sm" value="<?= $cari ?>" placeholder="Pencarian"
                          name="c"></label></div>
                  </form>
                </div>
              </div>
                ...
                <table class="table my-0" id="dataTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="barang-ubah.php?i=<?= $row['proid'] ?>" class="btn btn-primary"
                          style="background-color: #36b9cc;">Ubah</a></td>
                      <td><a href="barang-hapus.php?i=<?= $row['proid'] ?>" class="btn btn-primary"
              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">Menampilkan
                    <?= $count; ?> Data</p>
                </div>
                <div class="col-md-6">
