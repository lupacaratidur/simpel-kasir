...
<head>
  ...
  <title>Page Not Found - SiKasir</title>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
      <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
          ...
          <li class="nav-item" role="presentation"><a class="nav-link" href="barang.html"><i class="icon-layers"
                style="font-size: 20px;"></i><span style="margin-left: 10px;font-size: 18px;">Data Barang</span></a>
          </li>
          <li class="nav-item" role="presentation"><a class="nav-link" href="penjualan.html"><i class="icon-basket"
                style="font-size: 20px;"></i><span style="margin-left: 10px;font-size: 18px;">Penjualan</span></a></li>
          <li class="nav-item" role="presentation"><a class="nav-link" href="laporan.html"><i class="icon-list"
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="text-center mt-5">
            ...
            <p class="text-black-50 mb-0">Meri kembali ke jalan yang benar!</p><a href="/">← Back to Dashboard</a>
          </div>
        </div>
      </div>
