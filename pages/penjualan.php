    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
      <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
          ...
          <li class="nav-item" role="presentation"><a class="nav-link" href="barang.php"><i class="icon-layers"
                style="font-size: 20px;"></i><span style="margin-left: 10px;font-size: 18px;">Data Barang</span></a>
          </li>
          <li class="nav-item" role="presentation"><a class="nav-link active" href="penjualan.php"><i
                class="icon-basket" style="font-size: 20px;"></i><span
                style="margin-left: 10px;font-size: 18px;">Penjualan</span></a></li>
        ...
        <div class="text-center d-none d-md-inline">
          <div class="row">
            <div class="col"><a href="logout.php" class="btn btn-primary" style="background-color: #e74a3b;"><i
            ...
            <div class="row">
              <div class="col">
                <div class="card shadow">
                  ...
                  <div class="card-body">
                    <div class="form-group"><label for="address"><strong>Nama Pelanggan</strong><br></label><input
                        class="form-control" type="text" placeholder="Nama Pelanggan" value="<?= $trapelanggan ?>"
                        name="trapelanggan"></div>
                    <div class="form-row">
                      <div class="col">
                        <div class="form-group"><label for="city"><strong>No Faktur</strong></label><input
                            class="form-control" type="text" name="trafaktur" disabled value=<?= getFaktur() ?>></div>
                      </div>
                      <div class="col">
                        <div class="form-group"><label for="country"><strong>Tanggal</strong></label><input
                            class="form-control" type="text" disabled value=<?= $tanggal ?>></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                ...
                <div class="row" style="margin-top: 10px;">
                  <div class="col"><a href="penjualan-pilih.php" class="btn btn-primary"
                      style="width: 100%;background-color: #36b9cc;">Pilih Produk</a></div>
                  <div class="col"><input class="btn btn-primary" type="submit"
                      style="width: 100%;background-color: #1cc88a;" name="simpan" value="Simpan" /></div>
                </div>
              </div>
            </div>
          </form>
