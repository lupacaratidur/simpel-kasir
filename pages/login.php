        ...
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-12 col-xl-10">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    ...
                    <h4 class="text-dark mb-2 mt-4 font-weight-bold">SiKasir</h4>
                    </div>
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;../assets/img/cashier.jpg"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <input class="btn btn-success btn-block text-white btn-user" type="submit" name="simpan" />
                                        <hr>
                                    </form>
                                </div>
                            </div>
