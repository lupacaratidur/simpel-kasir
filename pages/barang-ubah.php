...
<head>
  ...
  <title>Ubah Produk - SiKasir</title>
                        ...
                        <div class="form-row">
                          <div class="col">
                            <div class="form-group"><label for="email"><strong>Nama Produk</strong></label><input
                                ...
                                value="<?= $row['pronama']; ?>" name="pronama"></div>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col">
                            <div class="form-group"><label for="last_name"><strong>Harga</strong><br></label><input
                                class="form-control" type="number" placeholder="Harga" value="<?= $row['proharga']; ?>"
                                name="proharga"></div>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col">
                            <div class="form-group"><label for="last_name"><strong>Stok</strong></label><input
                                class="form-control" type="number" placeholder="Sisa Stok"
                                value="<?= $row['projumlah']; ?>" name="projumlah"></div>
                          </div>
                        </div>
